...
namespace Tunynet.Common
{
    ...
    public class Comment : SerializablePropertiesBase, IEntity, IAuditable
    {
        ...
        {
            IUser user= DIContainer.Resolve<IUserService>().GetUser(this.ToUserId);
            if (user != null)
        ...
        public int HitTimes
        {
            get
            {
                CountService countService = new CountService(TenantTypeIds.Instance().EventPost());

...
namespace Spacebuilder.Group
{
    ...
    public class GroupRepository : Repository<GroupEntity>, IGroupRepository
    {
        ...
        /// <param name="groupId">群组Id</param>
        /// <returns></returns>
        public bool GetGroupDynamic(long groupId)
        {
            var sql_SelectDy = Sql.Builder.Select("IsDynamicPermission").From("spb_Groups").Where("GroupId = @0", groupId);
            return CreateDAO().FirstOrDefault<bool>(sql_SelectDy);
